 ...
 * the thing they authored are the same entity — so neither resolves. This is that
 * page, naming who maintains the course.
 */

const title = "Maintainers — Loop Engineering Crash Course";
const description = `${MAINTAINERS_LABEL} maintain the Loop Engineering Crash Course — a free, MIT-licensed curriculum on designing agent loops that run themselves.`;
  ...
  const schema = {
    ...
    "@graph": [
      ...maintainers,
      {
        ...
        mainEntity: MAINTAINER_IDS.map((id) => ({ "@id": id })),
      },
    ],
  };
    ...
    <>
      ...
      <main id="top" className="mx-auto w-full max-w-3xl px-6 py-16 md:py-24">
        ...
        <p className="mt-6 text-lg leading-relaxed text-muted">
          {MAINTAINER_NAMES.join(" and ")} maintain the{" "}
